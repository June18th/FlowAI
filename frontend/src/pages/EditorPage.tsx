...
import { Button, Input, Form, message, Checkbox, Select, Modal, Popconfirm, Spin } from 'antd';
import { SaveOutlined, FolderOpenOutlined, BugOutlined, LogoutOutlined, PlusOutlined, DeleteOutlined, DatabaseOutlined, ApiOutlined, AppstoreOutlined, CloseOutlined, SettingOutlined, FullscreenOutlined, FullscreenExitOutlined, SunOutlined, MoonOutlined, HomeOutlined, ArrowLeftOutlined } from '@ant-design/icons';
    ...
    <div className="workflow-editor-shell">
      ...
      <header className="workflow-topbar">
        <div className="workflow-title-group">
          ...
          />
          <img src="/flowai.svg" alt="FlowAI" className="workflow-brand-mark" />
          <div>
            <div className="workflow-brand">FlowAI</div>
            <Input
              value={workflowName}
      ...
      <div className="editor-body">
        <nav className="editor-sidebar">
          ...
          >
            <HomeOutlined />
            <span className="editor-sidebar-label">仪表盘</span>
          </button>
          <div className="editor-sidebar-divider" />
          <button
            className={`editor-sidebar-btn ${nodesPanelOpen ? 'is-active' : ''}`}
            onClick={() => setNodesPanelOpen(!nodesPanelOpen)}
          >
            <AppstoreOutlined />
            <span className="editor-sidebar-label">节点库</span>
          </button>
          <button
            className="editor-sidebar-btn"
          ...
          >
            <DatabaseOutlined />
            <span className="editor-sidebar-label">知识库</span>
          </button>
          <button
            className="editor-sidebar-btn"
          ...
          >
            <ApiOutlined />
            <span className="editor-sidebar-label">MCP 工具</span>
          </button>
          <div className="editor-sidebar-divider" />
          <button
            className="editor-sidebar-btn"
          ...
          >
            <SettingOutlined />
            <span className="editor-sidebar-label">模型配置</span>
          </button>
          <div className="editor-sidebar-divider" />
          <button
            className="editor-sidebar-btn"
          ...
          >
            <PlusOutlined />
            <span className="editor-sidebar-label">新建工作流</span>
          </button>
          <button
            className="editor-sidebar-btn"
          ...
          >
            <FolderOpenOutlined />
            <span className="editor-sidebar-label">加载工作流</span>
          </button>
        </nav>

        <div className="workflow-workbench">
          <aside className={`node-library-flyout ${nodesPanelOpen ? 'is-open' : ''}`}>
          ...
          <div
            className={`config-panel-backdrop ${configPanelOpen ? 'is-visible' : ''}`}
            onClick={() => setConfigPanelOpen(false)}
          />

          <aside className={`workflow-config-panel ${configPanelOpen ? 'is-open' : ''}`}>
            <div className="workflow-panel-heading">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <Button type="text" size="small" icon={<CloseOutlined />} onClick={() => setConfigPanelOpen(false)} />
              </div>
            </div>
            {selectedNode ? (
              ...
              {workflows.map((workflow) => (
                ...
                >
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div style={{ fontWeight: 650, color: '#172033', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {workflow.name}
                    </div>
